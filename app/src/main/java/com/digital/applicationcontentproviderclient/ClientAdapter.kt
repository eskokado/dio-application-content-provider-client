package com.digital.applicationcontentproviderclient
...
class ClientViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
    var clientTitle = itemView.findViewById(R.id.client_item_title) as TextView
    var clientDescription = itemView.findViewById(R.id.client_item_description) as TextView
}